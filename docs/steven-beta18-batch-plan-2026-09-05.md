...
Status: **MERGED 2026-09-06 into `tvos-shared-extraction` (`8560d305`)** — device pass (Show Hero OFF) + rc2 + DM owed; see the outcome section. **rc4 CUT (build 120, `a4dbb976`) is latest** — rc3 + the W4 reaches-first spend order; device pass still owed.
