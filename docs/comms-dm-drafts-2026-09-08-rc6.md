...
**Status: SENT 2026-09-08 ~18:30 ET (Reddit chat, Christian's go). Verified from a fresh ego process: one new message from u/youngchris2989 with the rc6 link, composer empty after the page-side Send click, no duplicate.** rc6 = build 122, tag `tvos-v0.3.0-beta.18-rc6`, `7ab5e25f` on `tvos-shared-extraction`, IPA 26,268,565 bytes at https://litter.catbox.moe/jit6b6.ipa (litterbox 72 h ≈ 2026-09-11 18:20 ET; copy `~/Downloads/NuvioTV-beta18-rc6.ipa`). Replies to his 09-07 10:09 PM ET message (Saga = poster art, double hero fixed both ways, collection images "resize live", pane-tail misread, bridge zoom ask, Down double-step on every movie). Carries rc6 = rc5 + the 09-08 batch (`760c0fac` + build bump `7ab5e25f`). Link and commit check filled in after the upload.
